...
<div class="col-sm-9 col-md-10 mt-5">
  <form class="mx-5" action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputName" placeholder="Ex: Sine.." name="requestername" pattern="[A-Za-z ]+" title="Only alphabetic characters are allowed">
    </div>
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="inputAddress2" placeholder="Kicukiro..." name="requesteradd2">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="date" class="form-control" id="inputDate" name="requestdate"  min="<?= date('Y-m-d') ?>">
      </div>
    </div>
