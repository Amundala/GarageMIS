...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="pdop">DOP (<small>Date of Purchase</small>)</label>
      <input type="date" class="form-control" id="pdop" max="<?php echo date('Y-m-d');?>" name="pdop" value="<?php if(isset($row['pdop'])) {echo $row['pdop']; }?>">
    </div>
    <div class="form-group">
