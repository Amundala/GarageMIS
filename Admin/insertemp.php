...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <?php if(isset($msg)) {echo $msg; } ?>
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="empName" name="empName"  pattern="[A-Za-z ]+" title="Only alphabetic characters are allowed">
    </div>
    <div class="form-group">
      <label for="empCity">City</label>
      <input type="text" class="form-control" id="empCity" name="empCity"  pattern="[A-Za-z ]+" title="Only alphabetic characters are allowed">
    </div>
    <div class="form-group">
