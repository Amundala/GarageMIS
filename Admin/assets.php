...
<div class="col-sm-9 col-md-10 mt-5 text-center">
  <!--Table-->
  <p class=" bg-dark text-white p-2">SPARE PARTS DETAILS</p>
  <?php
  ...
  echo '<table class="table">
    ...
    while($row = $result->fetch_assoc()){
      echo '<tr>
        ...
        <td>
          <form action="editproduct.php" method="POST" class="d-inline"> <input type="hidden" name="id" value='. $row["pid"] .'><button type="submit" class="btn btn-warning" name="view" value="View"><i class="fas fa-pen"></i></button></form>  
